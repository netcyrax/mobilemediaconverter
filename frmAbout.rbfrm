...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub more2()
		  ...
		  max =344
		  min = 287
		  if frmAbout.Height > min then
		    frmAbout.Height = min
		    lblEmail.Visible = false
		    lblEmailURL.Visible = False
		    lblURL.Visible = False
		    lblWeb.Visible = False
		  else
		    frmAbout.Height = max
		    lblEmail.Visible = True
		    lblEmailURL.Visible = True
		    lblURL.Visible = True
		    lblWeb.Visible = True
		  end if
		End Sub
...
#tag Events lblURL
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
		  ...
		  ShowURL "http://www.miksoft.net"
		  
		End Function
	#tag EndEvent
#tag EndEvents
#tag Events lblEmailURL
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
